# HAMSoft Engineering: Simple WindowSets
...
- New demo period for those who have tried this before.  
- bug fixes  
  
***Version 3.7***  
- Optimized the code for latest Mac technologies, so SWS now only works on 10.6 and later.  
- Optimized the "Hide Finder..." preference to prevent a hidden application from activating when restoring a set.  
- The Manager Window automatically opens at launch if it was open at last quit.  
- The Extra Images can be shown from the Tools menu for easy access.  
- New tool menu item to update the front finder window.  
- Other bug fixes  
...
Simple WindowSets will work on Macintosh computers with system software of MacOSX 10.6 and higher on Intel based Macs.  
...
Download: [Simple WindowSets Install.dmg](http://www.hamsoftengineering.com/assets/Simple%20WindowSets%20Install.dmg.zip)
...
![](.evernote-content/63E69DB8-6AFE-4384-A3D1-7D1499FDDBD4/A43F48D6-7FB8-4749-92A7-11415CD0CD13.png)

---

[🌐 原始链接](http://www.hamsoftengineering.com/products/sws/sws.html)

[📎 在印象笔记中打开](evernote:///view/207087/s1/7bc19ec2-d049-445e-9018-a1838e7af93a/7bc19ec2-d049-445e-9018-a1838e7af93a/)