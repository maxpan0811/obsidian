...
2017 年 4 月 3 日，Adobe 联合 Google [发布了思源宋体](https://source.typekit.com/source-han-serif/cn/)。思源宋体是[思源黑体](https://sspai.com/post/26251)的兄弟字体，同样支持繁简中文、日文、韩文四种语言，同样包含七种字重，同样使用 [OFL](http://scripts.sil.org/cms/scripts/page.php?site_id=nrsi&id=OFL) 自由授权，并[在 GitHub 上开源](https://github.com/adobe-fonts/source-han-serif/tree/release/)。其中，中文部分由我国的常州华文设计，遵循 GB 18030 通用规范汉字表，包含 8105 个规范字和 196 个额外字。
...
![](.evernote-content/8DC118A8-3EC2-405E-B652-1660F668EE2A/1B951A40-DB55-44B5-809D-39E632E82C54.png)

思源字体还支持七种字重，这在汉字字体历史上前所未有的。在思源字体之前，大部分中文字体只有两个字重（常规、粗体），微软雅黑有三个字重（细体、常规、粗体）。之后发布的苹果「苹方」字体支持六个字重，也不如思源字体丰富。

![](.evernote-content/8DC118A8-3EC2-405E-B652-1660F668EE2A/11EA8233-F08A-46B0-AC3E-9C5C8A05799B.png)
...
![](.evernote-content/8DC118A8-3EC2-405E-B652-1660F668EE2A/9F926C7F-03C5-4A93-9C31-16C168CEF360.png)
...
下载页面：[GitHub](https://github.com/adobe-fonts/source-han-serif/tree/release/)、[Google](https://www.google.com/get/noto/help/cjk/)

### 在本地使用

Adobe 提供了多语言的[下载指南（PDF）](http://www.adobe.com/content/dam/Adobe/en/products/type/pdfs/download-guide-source-han.pdf#page=4)，中文部分如下图所示

![](.evernote-content/8DC118A8-3EC2-405E-B652-1660F668EE2A/97846CFE-10CA-47D8-B81C-E3D83620217B.png)
...
在 **iOS 7** 及以上版本中，安装字体需要从 App Store 下载 [AnyFont](https://itunes.apple.com/cn/app/anyfont/id821560738?mt=8&at=1010lvgW) 或者 [WorkFlow](https://itunes.apple.com/cn/app/workflow-powerful-automation-made-simple/id915249334?mt=8&at=1010lvgW)。具体的方法可以参考我派的[这篇文章](https://sspai.com/post/36457)或者我的[这篇文章](https://www.septillion.cn/archives/2020)。iOS 6 及以前版本不支持安装字体。
...
![](.evernote-content/8DC118A8-3EC2-405E-B652-1660F668EE2A/047322E1-5E5A-4420-8ABD-568047074886.png)
...
庆幸的是，[Adobe Typekit](https://www.typekit.com/) 服务提供了对思源字体的托管，只需要注册一个 Adobe 账户，便可以免费使用思源系列字体。免费账户的访问量会有一些限制，升级账户需要付费。但是对于个人博客来说，免费账户足够用了。

你可以顺着 [Adobe 官方的指导](https://helpx.adobe.com/typekit/using/add-fonts-website.html)来创建账户、将字体添加到 kit 并将相应的 JavaScript 脚本添加到页面的 `<footer>` 中。Typekit 脚本会在网页加载完成后再加载字体，并且会根据需要只加载需要的字符，大幅提升速度。但是即使是如此，中文字体的加载还是会相对缓慢，所以不建议大篇幅使用动态字体，文章正文还是使用系统内置字体更好。Typekit 使用的是 Akamai CDN 服务，在国内的速度差强人意（差强人意：大体令人满意）。

这里主要说一下**如何在 CSS 中正确声明思源字体**。上文提到，思源字体有多个版本，针对不同的操作系统和语言，其使用的名称也不同。因此在 CSS 代码中正确地声明思源字体需要考虑所有思源字体的版本。
...
我在[我的博客](https://www.septillion.cn)标题处使用思源宋体，字重高达 900。这种字重只有思源宋体能提供，其他任何宋体都不能实现如此丰富的字重。如果系统中已经安装思源宋体，优先使用本地字体。如果本地没有安装，则从 Typekit 下载。如果思源宋体下载失败，寻找系统内的宋体使用。
...
作者注：本文首先发表于我的博客 [Septillion's Blog](https://www.septillion.cn/archives/2560)，文章经过修改，加入少数派相关链接。

---

[🌐 原始链接](https://sspai.com/post/38705)

[📎 在印象笔记中打开](evernote:///view/207087/s1/8cfdc9ab-e0a9-417f-8e02-6284f1f93d28/8cfdc9ab-e0a9-417f-8e02-6284f1f93d28/)