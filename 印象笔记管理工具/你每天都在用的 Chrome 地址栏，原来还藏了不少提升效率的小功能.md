...
[![](.evernote-content/0EBF071F-EDB1-4ECF-83DA-95767A4704FD/4D9F00CA-E9FE-4135-BAAD-B03443DB312B)](https://sspai.com/user/696752/updates) 

#### [xuuxnn](https://sspai.com/user/696752/updates)
...
![](.evernote-content/0EBF071F-EDB1-4ECF-83DA-95767A4704FD/835E07A9-D0A8-4F57-BD79-5B81007EC7EF.jpg)

**b.** 依次进入 Chrome 设置 > 管理搜索引擎 > 添加，先自定义一个关键字，然后把刚刚复制的网址粘贴到网址那一栏，将上一步搜索的词汇「apple」替换成 `%s`。

![](.evernote-content/0EBF071F-EDB1-4ECF-83DA-95767A4704FD/D50218CF-E558-4D08-929B-E84A13362B29.png)
...
![](.evernote-content/0EBF071F-EDB1-4ECF-83DA-95767A4704FD/DCF435DF-41D5-488D-A2E0-09C4D9838E6F.gif)
...
![](.evernote-content/0EBF071F-EDB1-4ECF-83DA-95767A4704FD/EA238640-2EA0-42BA-97F8-C7FCD8D16090.png)

**数学计算：**在地址栏中输入算式，下面会实时显示计算结果

![](.evernote-content/0EBF071F-EDB1-4ECF-83DA-95767A4704FD/477A8301-A579-4A74-A4B0-78A98C5E64F1.png)

**单位换算：**输入格式是「数量单位 = 目标单位」

![](.evernote-content/0EBF071F-EDB1-4ECF-83DA-95767A4704FD/0570F9E7-F659-49CF-8436-D4F7E6AC2907.png)

**查询天气：**直接在地址栏输入「天气预报」或者「weather」，下面就会显示所在城市的天气信息

![](.evernote-content/0EBF071F-EDB1-4ECF-83DA-95767A4704FD/D3799D03-0F04-4674-86D4-D6BED2AC6A19.png)

**英英释义：**输入 define + 单词，下面会显示该单词的英文解释。有些单词如果不显示释义，就在输入完成后再空格 + delete (Mac), 这样基本都会显示了。

![](.evernote-content/0EBF071F-EDB1-4ECF-83DA-95767A4704FD/A606B2B9-1029-429D-8F3A-F31BB439AEA9.png)
...
Omnibox Timer 是一款非常实用的定时提醒插件。在地址栏输入关键词「tm」+ 空格来激活它，接着输入时间，代表多久以后提醒，再空格输入提醒的文字内容，最后回车即可。比如下图这样，「30 睡觉」就代表 30 分钟后会提醒你睡觉。

![](.evernote-content/0EBF071F-EDB1-4ECF-83DA-95767A4704FD/CB96FBDA-37FE-477E-9608-43E6A4323F75.png)
...
![](.evernote-content/0EBF071F-EDB1-4ECF-83DA-95767A4704FD/773B249F-31BF-4508-9ED2-7864D7CBAE8A.png)

### [Auto Text Expander](https://chrome.google.com/webstore/detail/auto-text-expander-for-go/iibninhmiggehlcdolcilmhacighjamp) ： 文本替换

这是一款文本替换插件，和输入法里的文本替换类似，比如你可以输入两个字母就弹出你的邮件地址：

![](.evernote-content/0EBF071F-EDB1-4ECF-83DA-95767A4704FD/9E325558-77A8-4531-A171-5794499E04F6.gif)
...
![](.evernote-content/0EBF071F-EDB1-4ECF-83DA-95767A4704FD/82285CBA-68D8-492F-85AF-A587692459B7.gif)
...
![](.evernote-content/0EBF071F-EDB1-4ECF-83DA-95767A4704FD/F7EB5B34-4387-4C94-9FEC-1835D82756D5.gif)
...
![](.evernote-content/0EBF071F-EDB1-4ECF-83DA-95767A4704FD/033730DD-1D87-4ED2-BF69-EDEF630BCD68.gif)
...
![](.evernote-content/0EBF071F-EDB1-4ECF-83DA-95767A4704FD/367753DB-7F77-4F84-8965-81C5D04C7946.gif)
...
**a.** 点进这个[链接](https://telegram.me/botfather)开始和 BotFather 聊天

**b.** 发送消息 /newbot

**c.** 依次回复它要设置的机器人的昵称和用户名，用户名必须以「bot」结尾。

![](.evernote-content/0EBF071F-EDB1-4ECF-83DA-95767A4704FD/F3F904E7-6A04-44F0-8748-C08E5EFF5AAC.jpg)

**d.** 在用户名没有和别人重复后机器人就创建成功了，BotFather 会回复你一条包含机器人的链接和 token 的信息，这个 token 后面就会用到。

![](.evernote-content/0EBF071F-EDB1-4ECF-83DA-95767A4704FD/0F33C51B-CA88-48A6-9DCD-CD86D13D8015.jpg)
...
把其中的 `$TOKEN` 替换成第（一）部分中自己创建的机器人的 token，`12345` 替换成上一步得到的 Chat ID，`Hello+World` 替换成想要机器人给你发送的消息内容。替换完成后再回车，手机上马上就能收到机器人发来的消息了。[来源](https://www.forsomedefinition.com/automation/creating-telegram-bot-notifications/)
...
![](.evernote-content/0EBF071F-EDB1-4ECF-83DA-95767A4704FD/D2E5FDC1-0E73-44AE-A9CE-0330AECE8516.jpg)
...
[🌐 原始链接](https://sspai.com/post/44922)

[📎 在印象笔记中打开](evernote:///view/207087/s1/d7787538-4f80-479b-9be4-730e6ab6fb9e/d7787538-4f80-479b-9be4-730e6ab6fb9e/)