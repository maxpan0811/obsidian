# 深度解读：Workflow 被苹果收购，意味着什么

---

北京时间 2017 年 3 月 23 日星期四，苹果对 [Workflow](https://sspai.com/tag/Workflow) 完成了收购。根据 TechCrunch 的 [报道](https://techcrunch.com/2017/03/22/apple-has-acquired-workflow-a-powerful-automation-tool-for-ipad-and-iphone/)，交易已经结束，具体金额目前未知。

收购的对象包括 Workflow 这款 iOS 应用，以及它背后的技术与四位开发者组成的团队：[Ari Weinstein](https://twitter.com/AriX)、[Conrad Kramer](https://twitter.com/conradev)、[Ayaka Nonaka](https://twitter.com/ayanonagon) 和 [Nick Frey](https://twitter.com/nickfrey)。

![](.evernote-content/9D55204B-A381-4768-B6A4-695572419CEC/2F144BEB-C62E-41EE-9A9F-4F8DF84E6975.jpg)图为 2015 年 Workflow 获得了 Apple Design Award 的照片，当时另一位开发者 Ayaka Nonaka 还未加入。

被收购的 Workflow 将继续保持开发，今后仍可以在 [App Store 下载](https://itunes.apple.com/cn/app/id915249334?mt=8)，并且价格变为免费。
...
如果你想对 Workflow 有更深入的了解，可以看我之前写过的系列教程：[《从零开始用 Workflow》](https://sspai.com/topic/100)

![](.evernote-content/9D55204B-A381-4768-B6A4-695572419CEC/EE8D3198-FBA4-4D19-A5B9-0DDD1BB7AE70.png)
...
对于多数人来说，Workflow 最直观的优秀之处有两个：一是它形式上突破了 iOS 的沙盒限制，你可以从一个应用获取信息，发送到另一个应用中，比如你可以在豆瓣电影里不离开 App，然后按照一定的格式 [把电影加到 Todoist 中](https://sspai.com/post/37830)；二是它操作要比同类应用更加容易，另一款自动化领域的明星应用 [Pythonista](https://itunes.apple.com/cn/app/pythonista/id528579881?mt=8) 的实际能力要在 Workflow 之上，评价也很高。但因为使用它要用上实打实的编程语言，门槛陡增。Workflow 不光有人性化的图形界面和易于理解的拖拽式交互，它还内置了许多动作，可以省下使用者用来思考或操作的时间。比如你可以用 Apple 的 API 获取 iTunes Store 和 App Store 里商品的信息，但这个动作做出来会偏复杂。于是 Workflow 就直接提供了一组动作，可以非常直观地实现这个功能。
...
就在 3 月 15 日，Workflow 的 Blog 上也更新出了 [一则真实的故事](http://blog.workflow.is/post/158453974554/reclaiming-independence-logans-story)，它讲述了因为大脑缺氧 45 分钟，导致后天失明，几乎失语，外加行动有严重障碍的 Logan 在日常生活中是如何使用 Workflow 让智能语音设备 Echo 告诉他天气的。除此之外，Logan 还会用 Workflow 给朋友发短信。娱乐方面，Logan 能用 Workflow 控制播放器，他可以播放、暂停音乐、切歌，甚至能在切歌之前，让 Workflow 告诉他下一首歌是什么。[（点此查看 Logan 的演示视频）](http://v.qq.com/x/page/u0386tfsir0.html)

![](.evernote-content/9D55204B-A381-4768-B6A4-695572419CEC/331BA7D9-AB6C-4737-BEE9-E2263C2EEF8A.png)Logan 正在操作 Workflow
...
Workflow for Mac 的呼声一直存在，因为在 Mac 上的两个近似物——Automator 和 [Keyboard Maestro](https://sspai.com/search/article?q=Keyboard%20Maestro)，要么功能不够强大，要么强大得不好学，而且长得都不如 Workflow 可爱。
...
也许大家还没注意到，在昨天更新的 Workflow 1.7.3 版的 [Changelog](http://my.workflow.is/whatsnew) 里，出现了这两条内容：
...
这次更新还关闭了 Workflow 的分享区，这可是 Workflow 在 1.6 版本里着重推出的功能。看过 [我写的 Workflow 更新文章](https://sspai.com/user/681230/posts) 的读者应该都知道，Workflow 的百分位（1.x.x）更新都非常强悍，像对 HTTP 请求方式的支持、在 Workflow 运行另一个 Workflow 都是在百分位更新出的功能。Workflow 团队把分享区放到十分位（1.x）来推，肯定是想要做好这个东西。所以不难推测，这次关闭分享区是苹果权衡之后的决定。所以会不会再开以及什么时候再开，就很难说了。
...
很多人认为这个事件是苹果不再重视用户自动化（主要是 User Script & Automation）的信号。Sal Soghoian 本人似乎也有这种担忧，他似乎觉得苹果要在 App Extensions（类似 iOS 上的 Share Sheets）上发力，抛掉 User Automation。于是专门在 MacStories 写了一篇《[App Extensions Are Not a Replacement for User Automation](https://www.macstories.net/stories/app-extensions-are-not-a-replacement-for-user-automation/)》。
...
两年前，在 Workflow 首发的一周后，我在第一篇关于 [Workflow 的深度测评](https://sspai.com/post/27733) 末尾写道：
...
Workflow 的出现本身也是一个有趣的故事。根据 [Cult of Mac 的报道](http://www.cultofmac.com/305826/workflow/)，最初这个团队只有 Ari Weinstein 和 Conrad Kramer 两人。Workflow 的初版原型只用了不到 48 个小时。

两位开发者后来赢得了 [Thiel 奖学金](http://thielfellowship.org/)，这是专门为 20 以下的年轻人提供的奖学金，奖金 10 万美元，要求是让他们暂停学业来创业或者直接进行科学研究。Weinstein 直接从麻省理工学院退学，Kramer 也从麻省理工学院休学，两人开始了他们的创业生涯。
...
[🌐 原始链接](https://sspai.com/post/38438)

[📎 在印象笔记中打开](evernote:///view/207087/s1/de611420-9c1f-4ccc-a1fe-69e16897b377/de611420-9c1f-4ccc-a1fe-69e16897b377/)