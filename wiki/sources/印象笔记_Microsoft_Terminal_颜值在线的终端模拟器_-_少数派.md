---
title: "Microsoft Terminal 颜值在线的终端模拟器 - 少数派"
type: source
created: 2026-07-15
updated: 2026-07-15
source_path: 印象笔记管理工具/Microsoft Terminal 颜值在线的终端模拟器 - 少数派.md
tags: [印象笔记]
---

# Microsoft Terminal 颜值在线的终端模拟器 - 少数派

# Microsoft Terminal 颜值在线的终端模拟器 - 少数派 --- Microsoft Terminal 颜值在线的终端模拟器 ============================
...
![](.evernote-content/63E30F6E-8228-4DB3-8AB7-78776838F243/8A56EC79-69E6-4665-8201-34AD6003B60F.png)
...
而现在的安装方法也很简单，从 Microsoft Store 里面搜索 「[Microsoft Terminal](https://www.microsoft.com/zh-hk/p/windows-terminal-preview/9n0dx20hk701?SilentAuth=1&wa=wsignin1.0&activetab=pivot:overviewtab)」 就可以直接安装和卸载了。
...
![](.evernote-content/63E30F6E-8228-4DB3-8AB7-78776838F243/00894A47-502A-465E-940E-E91CA01BF672.gif)
...
![](.evernote-content/63E30F6E-8228-4DB3-8AB7-78776838F243/3A550599-F1C2-42A4-8724-6DA16D3E005F.gif)
...
![](.evernote-content/63E30F6E-8228-4DB3-8AB7-78776838F243/397D061E-D53B-45BB-91B7-4BD197001316.png)
...
![](.evernote-content/63E30F6E-8228-4DB3-8AB7-78776838F243/B53556B4-013E-4A29-BA06-4CA2938A2B8E.png)

![](.evernote-content/63E30F6E-8228-4DB3-8AB7-78776838F243/A49C5A84-85E8-4F46-9887-8588D187D47C.png)
...
我最近使用的是微软为开发者打造的一款字体 Cascadia，开源仓库在这里 => [Cascadia Code](https://github.com/microsoft/cascadia-code/releases) . 我很喜欢它，得益于对 unicode 编码的支持，在 GPU 加速的情况下，它总能给我很多很好看的小惊喜，比如 `=>` 会被渲染成一个完整的箭头，并且跟随进度条移动。更多的就等你们使用发掘啦。

我用的是里面默认的 「One Half Dark」配色，我觉得很好看，搭配 70% 的透明度和 5 pixel 的外边距，整体效果很不错。

![](.evernote-content/63E30F6E-8228-4DB3-8AB7-78776838F243/9B84C53A-3886-4F31-B5A3-C71F86D2CC84.png)
...
[🌐 原始链接](https://sspai.com/post/57391)

[📎 在印象笔记中打开](evernote:///view/207087/s1/8ff325b3-a4d8-4c1d-9c99-95e437f9c19a/8ff325b3-a4d8-4c1d-9c99-95e437f9c19a/)