---
title: Balu Kosuri——LLM Wiki (Karpathy Pattern)
type: source
created: 2026-06-14
updated: 2026-06-14
source_path: 印象笔记管理工具/Balu Kosuri——LLM Wiki (Karpathy Pattern).html
tags: [印象笔记, AI/编程]
updated: 2026-06-27
---
...
guid: ea3fd0f4-92d6-4d53-b7f1-16e8df90a473
---

# Balu Kosuri——LLM Wiki (Karpathy Pattern)

[balukosuri](https://github.com/balukosuri)/[llm-wiki-karpathy](https://github.com/balukosuri/llm-wiki-karpathy)
...
Cursor reads [`CLAUDE.md`](http://CLAUDE.md) automatically and understands the wiki's structure, page formats, and workflows.

If you use a different AI agent (Claude Code, Codex, etc.), paste the contents of [`CLAUDE.md`](http://CLAUDE.md) into your agent's context.
...
| The schema | [`CLAUDE.md`](http://CLAUDE.md) | You + AI | Defines page types, workflows, and conventions. Edit this to customize the AI's behavior for your domain. |
...
The schema file [`CLAUDE.md`](http://CLAUDE.md) is not set in stone. Edit it to fit your needs:
...
Ingest（摄取） one source at a time. You can batch-ingest, but you lose the chance to guide the AI. Stay involved — read the summaries, tell it what to emphasize, ask follow-ups during ingestion.
...
**Check the glossary（词汇表） before writing.** Open `wiki/glossary.md` before you write anything. It has the right terms, the wrong terms, and the reasons behind each choice.
