---
title: "别被生态绑架，这两个 app 让你的 Windows 和 iPhone 也能同步剪贴板"
type: source
created: 2026-07-15
updated: 2026-07-15
source_path: 印象笔记管理工具/别被生态绑架，这两个 app 让你的 Windows 和 iPhone 也能同步剪贴板.md
tags: [印象笔记]
---

# 别被生态绑架，这两个 app 让你的 Windows 和 iPhone 也能同步剪贴板

# 别被生态绑架，这两个 app 让你的 Windows 和 iPhone 也能同步剪贴板 --- 智能摘要 Apple生态中的跨设备剪贴板同步很实用，比如你可以在iPhone上复制文本、然后在Mac
