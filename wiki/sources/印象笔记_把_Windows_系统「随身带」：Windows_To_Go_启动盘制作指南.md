---
title: "把 Windows 系统「随身带」：Windows To Go 启动盘制作指南"
type: source
created: 2026-07-15
updated: 2026-07-15
source_path: 印象笔记管理工具/把 Windows 系统「随身带」：Windows To Go 启动盘制作指南.md
tags: [印象笔记]
---

# 把 Windows 系统「随身带」：Windows To Go 启动盘制作指南

# 把 Windows 系统「随身带」：Windows To Go 启动盘制作指南 --- 拥有 Mac 的同学大概都会碰到一个头疼的问题，那就是使用 Windows 的使用需求。macOS 虽好，不
...
拥有 Mac 的同学大概都会碰到一个头疼的问题，那就是使用 Windows 的使用需求。macOS 虽好，不过总是会有一些讨厌的软件没有 Mac 版本，这时就不得不在 Mac 上跑 Windows 了。使用虚拟机？它对硬件要求比较高；装 Boot Camp？这对于容量紧张的 Mac 用户来说并不是一个好主意。那还有什么办法在 Mac 上愉快的使用 Windows 呢？[Windows To Go](https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=1&cad=rja&uact=8&ved=0ahUKEwih39-PxMDbAhVCNrwKHZZuBscQFggnMAA&url=https%3A%2F%2Fdocs.microsoft.com%2Fen-us%2Fwindows%2Fdeployment%2Fplanning%2Fwindows-to-go-overview&usg=AOvVaw0k0dqnzHPIZLH1oRXLZr0N) （以下简称为 WTG）让还在纠结的 Mac 用户有了第三个选择。
...
![](.evernote-content/26CFB9A6-1EE4-45C8-A985-EE41B5B15CBE/5A48B7F9-AF81-417B-9D74-3BBD4F11B2CD.png)京东上的 WTG 认证 U 盘，价格比一般的 U 盘价格高出许多
...
建议前往 [微软官方网站](https://www.microsoft.com/zh-cn/software-download/windows10ISO) 下载原版镜像。

第一步：插上外置存储，并装载你所下载的 **Windows 10 企业版**镜像，通常情况下只需双击该镜像文件即可装载。

![](.evernote-content/26CFB9A6-1EE4-45C8-A985-EE41B5B15CBE/88EEE88C-A2CC-4718-B69A-60C0B5DBC7CF.jpg)

第二步：在任务栏中的搜索栏（位于开始按钮右边）处输入「Windows To Go」并打开，你也可以在控制面板中找到「Windows To Go」。

![](.evernote-content/26CFB9A6-1EE4-45C8-A985-EE41B5B15CBE/D3BD5805-FD8C-47FD-9318-18E79394AB92.jpg)

第三步：打开 「Windows To Go」 之后会出现如下画面，选择你所需要的外置存储并按下一步。

![](.evernote-content/26CFB9A6-1EE4-45C8-A985-EE41B5B15CBE/FFAF9B74-ABEC-4B7A-A92D-3638B38D91EF.jpg)
...
![](.evernote-content/26CFB9A6-1EE4-45C8-A985-EE41B5B15CBE/AC5BFF97-B4DA-4A5E-9075-9C33FC4C0152.jpg)

第五步：接下来就来到了设置 BitLocker 密码的界面，这个的话就根据个人喜好来决定设置或者是不设置了。

![](.evernote-content/26CFB9A6-1EE4-45C8-A985-EE41B5B15CBE/8A636F43-E6F5-4766-93B8-80C452F5633E.jpg)

第六步：之后，WTG 工具会再次提示你**备份好你的数据**，并在下一步**格式化你的外置设备**。确认完成后点击「创建」，接下来就等待着进度条完成吧。

![](.evernote-content/26CFB9A6-1EE4-45C8-A985-EE41B5B15CBE/E3781211-C5E1-4016-8D93-F209BABF6913.jpg)

第七步：当进度条完成后，WTG 工具会提示你是否在下次传奇电脑时从该 WTG 工作区启动，这里我们选择「否」并根据需要点击下面的选项。至此，官方工具安装 WTG 的步骤就结束了。

![](.evernote-content/26CFB9A6-1EE4-45C8-A985-EE41B5B15CBE/D202F656-293D-4176-B679-C83196069E2D.jpg)
...
在网上有许多制作 WTG 的第三方工具，在这里我们选取比较知名的 [WTG 辅助工具](https://bbs.luobotou.org/thread-761-1-1.html) 以向大家展示第三方工具的使用方法。

第一步：同样的，连接外置设备，装载你的 Windows 10 镜像。在这里你可以装载**任意版本的 Windows** 镜像。

第二步：打开 WTG 辅助工具，来到以下界面。

![](.evernote-content/26CFB9A6-1EE4-45C8-A985-EE41B5B15CBE/25BD094B-BC8B-478B-AB72-4713DDCFCF77.jpg)
...
![](.evernote-content/26CFB9A6-1EE4-45C8-A985-EE41B5B15CBE/40345E95-0C7A-4D16-B22C-064BCC9B6B5E.jpg)
...
![](.evernote-content/26CFB9A6-1EE4-45C8-A985-EE41B5B15CBE/10010F5E-E4A6-4ADF-A759-AA6002204749.png)

第二步：选择 Windows 支持软件的下载位置，点击「存储」，之后等待下载完成。

![](.evernote-content/26CFB9A6-1EE4-45C8-A985-EE41B5B15CBE/6D7AB2AF-BAE6-44E5-9E37-8F9EB45ED06C.png)
...
![](.evernote-content/26CFB9A6-1EE4-45C8-A985-EE41B5B15CBE/1D845881-759E-4EB3-A347-DA264C481E56.jpg)

第五步：选择好之后，你的 Mac 的屏幕上会出现 Windows 徽标，等待 Windows 准备好之后会出现设置界面。

![](.evernote-content/26CFB9A6-1EE4-45C8-A985-EE41B5B15CBE/6C3B789E-B28C-4BED-B94D-F1B902C35878.jpg)

这时你会发现 Mac 的触控板和键盘**都不能使用**，所以接上你刚刚准备好的鼠标，继续进行设置。

![](.evernote-content/26CFB9A6-1EE4-45C8-A985-EE41B5B15CBE/B81CE521-A167-43FE-A029-98C443FFCE2E.jpg)

到了输入用户名的步骤时，由于键盘无法使用，这时就得另想办法了，如果你有外接键盘的话是最好的，如果没有的话也不用着急，看到左下角的辅助功能按钮吗？用鼠标点击它，然后选择「屏幕键盘」，这时候就可以继续设置了。

![](.evernote-content/26CFB9A6-1EE4-45C8-A985-EE41B5B15CBE/AF0A5BF8-744E-4FAF-B2BF-49FEC28A3FDA.jpg)
...
![](.evernote-content/26CFB9A6-1EE4-45C8-A985-EE41B5B15CBE/67773FB9-DBB2-45B3-AD93-ADD916E7BDB3.jpg)
...
[🌐 原始链接](http://sspai.com/post/44699)

[📎 在印象笔记中打开](evernote:///view/207087/s1/8a69ff0a-3201-45ba-bd35-7fb61aa23cbd/8a69ff0a-3201-45ba-bd35-7fb61aa23cbd/)