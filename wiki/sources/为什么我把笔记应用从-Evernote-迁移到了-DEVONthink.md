---
title: 为什么我把笔记应用从 Evernote 迁移到了 DEVONthink？
type: source
created: 2026-06-20
updated: 2026-06-20
source: 印象笔记
source_path: 印象笔记管理工具/为什么我把笔记应用从 Evernote 迁移到了 DEVONthink？.html
tags: [印象笔记]
updated: 2026-06-27
updated: 2026-06-27
updated: 2026-06-27
...
guid: 21a330ee-1aeb-4be0-8208-8b827db2de3b
---
...
![](attachments/dc8c39de158c6179.png)Evernote 裁剪前后的网页对比
...
![](attachments/4b9169341bb0e3d5.png)二者自动化能力比较
...
![](attachments/8aa969e041137064.png)使用 BBEdit 高亮代码
...
![](attachments/610851fa42462599.png)一篇无复杂格式的笔记
...
![](attachments/4114e036be02f2cf.png)升级到 Pro
...
![](attachments/d9ca02f8c57a8660.png)Mac 与 iOS DEVONthink 的同步方式
...
![](attachments/e63103ad90bfcadf.png)BOX 同步

- **User Name** 与 **Password** 就是 BOX 的用户名和密码，如果使用 Dropbox 因为 Dropbox 使用 OAuth 2 验证，会弹出网页进行授权。
- **Sync Store Name** ，在云端部分 DEVONthink 数据的名字。虽然在本地，DEVONthink 的数据是以一个个 `*.dtBase2` 文件存储的；但是在云端，所有的 `dtBase2` 文件会被打包成一个 `dtCloud`文件。当不同平台的 DEVONthink 之间同步时，使用相同的云平台，输入**相同的** `Sync Store Name`，就会同步同样的数据。 ![](attachments/4db41a5fe6a04777.png)
...
![](attachments/91128ff9baa95f11.png)从 Evernote 导入的一个笔记本
...
![](attachments/ce2fee6a5b04e9f0.png)Keyboard Maestro
...
![](attachments/f4395b83bc5c7587.png)导入与索引
...
![](attachments/4dd045bf1837c6f8.jpg)Exclude Groups from Tagging
...
![](attachments/7515f468e74b898c.png)Tags 为蓝色；Groups 为灰色

此时如果我按下快捷键 `⌃Control - ↩Return` 为某个文件标记了多个 Groups 后：

![](attachments/96f2e795099cc35c.png)alter to replicant
...
![](attachments/7ad00662e5171dc6.png)Replicant 与 Duplicate
...
![](attachments/237987c75d3d0b58.png)Classify See Also
...
![](attachments/58f6bc8342f5bbcb.png)DEVONthink Format
...
![](attachments/01783489fb87bda5.png)Context
...
![](attachments/237987c75d3d0b58.png)DEVONthink AI
...
![](attachments/09ca6fe590e5dfb9.png)Evernote Notes History
...
![](attachments/038cf774606480fe.png)DEVONthink Sorter
...
![](attachments/714443ac762a92ad.png)DEVONthink Global Inbox
...
![](attachments/a70129f1afa285b9.png)DEVONthink Clipper 和 Bookmarklets
...
![](attachments/dacd0701ee5529e6.png)小书签的代码
...
![](attachments/e001041dad2bcd2a.png)DEVONthink Web Browser
...
![](attachments/b276e0aa754f191b.png)比较
...
![](attachments/d9a2db968c58e40a.png)Open in DEVONthink Macro
...
![](attachments/86e38da7e649505a.png)Quick Search in DEVONthink
