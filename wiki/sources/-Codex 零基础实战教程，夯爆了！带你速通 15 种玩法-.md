...
guid: c7401861-b0ee-4d56-873a-a48c88fc68c4
---
...
![](attachments/94cbd3ab2fd0d844.png)
...
![](attachments/416e9aec4965fc41.png)

Codex 会自动联网搜索最新信息，然后帮忙整理总结，这下不怕错过新资讯了。

![](attachments/edb1b8048df34f4d.png)
...
![](attachments/3bab59466474cde5.png)
...
![](attachments/fa207e70cc61846d.png)
...
![](attachments/7c12360d0a2fa989.png)

最后给你一份清晰的报告，列出哪些大文件占了多少空间，并给出清理建议。

![](attachments/fcff6d5d3f3fa935.png)
...
![](attachments/454e0912914a9616.png)
...
![](attachments/524a05b4b7a9779c.png)

如果你选择的权限模式是「默认模式」，AI 想删除文件的时候会弹出一个确认框，问你同不同意，防止 AI 搞乱你的电脑。

![](attachments/be2870ee9a7129d5.png)

但由于我选的是「自动审核」，AI 自己完成了审核并批准，省去了人工操作的麻烦。

![](attachments/2de28dfa2a3578df.png)
...
![](attachments/4367693036d09cdd.png)

你也可以在对话框里输入 `/状态`，这种以 `/` 开头的快捷输入叫做「斜杠命令」，是 Codex 内置的快捷操作方式：

![](attachments/16966b3f4e889f92.png)

输入之后，Codex 会直接在对话中显示当前的上下文余量和额度信息。

![](attachments/cc13a3d2ce9bd9f5.png)
...
![](attachments/55ec5626938a56d2.png)
...
![](attachments/e8ff93ae8d53efe3.png)
...
![](attachments/d4261ba2eb3ac334.png)

最后会生成一份实现计划文档，包括简介、核心要求、测试计划等信息。你做的网站越复杂，越要仔细阅读这个文档。

![](attachments/ff76be7dc0f2fd35.png)
...
![](attachments/133b3f6349f5b9a9.png)
...
![](attachments/4c7b6ac5032701fe.png)

最终抓取到的数据表格非常清晰，链接前面甚至还有图标~

![](attachments/8f0bc10dbfc12e6e.png)
...
![](attachments/59a11eeafe462e51.png)

你可以在这里看到所有已连接的应用，比如前面装的 Chrome 扩展，其实也属于 Computer Use 体系的一部分。

![](attachments/e170ead73f7f9a4d.png)
...
![](attachments/70f793c7e348a29e.png)

效果不错吧，生成了一张非常精美的新壁纸，我觉得比原图还好看。。。今晚可以做个好梦了~

![](attachments/3649b3ccf83f1cb0.png)
...
![](attachments/931376e8b5900d08.png)

然后 AI 打开了备忘录，写入内容，并添加了音乐文件，能够顺利播放。

![](attachments/f6f2f7773e4075ef.png)
...
![](attachments/82eeffc1fe253bc5.png)
...
![](attachments/f875cbb531bbad6a.png)
...
![](attachments/e714b1ab00c5d987.png)
...
![](attachments/12a96513f052390b.png)
...
![](attachments/cb840d2923c3f10f.png)

看看 AI 生成的图片，你觉得怎么样？是不是夯爆了？

![](attachments/3734d387a82c53d2.png)
...
![](attachments/8f599e87fb9c3255.png)
...
![](attachments/50bbc19dd1223f57.png)

安装完成后，在技能管理面板里就能看到新增的技能了：

![](attachments/9690f195fbbd9759.png)
...
![](attachments/7f1097f5345ca091.png)

最后 AI 生成了可直接播放的视频，来看看效果：

![](attachments/795ab08b52dc0fb0.png)
...
![](attachments/c72c64b1575f5eed.png)
...
![](attachments/4aaa0366a9380182.png)
...
![](attachments/e11588b3653f15b9.png)

安装后重启 Codex，在设置里的 MCP 服务器列表中能看到它。首次使用前，还需要进行身份验证，

![](attachments/1b0092bb6e71ee26.png)

在自动弹出的 Context7 网页中登录，然后同意授权。

![](attachments/6d80e70d583d4445.png)

授权成功后，就可以愉快地使用 MCP 了：

![](attachments/127fb5b95d97ff71.png)
...
![](attachments/2411aa3200828274.png)
...
![](attachments/58b5ddf38253d70c.png)
...
![](attachments/db5ebf031ce58226.png)
...
![](attachments/39005507dfd6154a.png)
...
![](attachments/9f9c7c6ddfec4bf1.png)
...
![](attachments/8329f2e067435381.png)

创建成功后，时间一到 Codex 就会自动开启一个对话来执行任务，我们也可以先手动执行一次看看效果。

![](attachments/aa60698a623cf305.png)

点击任务，能够查看详细信息：

![](attachments/1ca0bce27153389d.png)

点击某个运行历史记录后，还能查看正在执行的任务对话，建议多观察任务的表现，持续迭代优化提示词：

![](attachments/90a70e04bdd3adb5.png)
...
![](attachments/3654c86f6b9a3b48.png)
...
![](attachments/9623ccda8dc41b8f.png)
...
![](attachments/557ceea537c82f42.png)
...
![](attachments/289a71cfd7b61c2b.png)
...
![](attachments/a8bbda72d06d00b1.png)
...
![](attachments/871a11d785a0484a.png)
...
![](attachments/24badc128257aae8.png)
...
![](attachments/6e62b6f73cfef8ef.png)
