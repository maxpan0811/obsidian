---
title: "在 Windows 10 上安装软件，你现在可以用微软的包管理工具了：WinGet - 少数派"
type: source
created: 2026-07-15
updated: 2026-07-15
source_path: 印象笔记管理工具/在 Windows 10 上安装软件，你现在可以用微软的包管理工具了：WinGet - 少数派.md
tags: [印象笔记]
---

# 在 Windows 10 上安装软件，你现在可以用微软的包管理工具了：WinGet - 少数派

# 在 Windows 10 上安装软件，你现在可以用微软的包管理工具了：WinGet - 少数派 --- 在 Windows 10 上安装软件，你现在可以用微软的包管理工具了：WinGet ====
