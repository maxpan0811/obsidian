---
title: "Homebrew 技巧：使用 Mackup 快速备份 Mac 软件的配置文件"
type: source
created: 2026-07-15
updated: 2026-07-15
source_path: 印象笔记管理工具/Homebrew 技巧：使用 Mackup 快速备份 Mac 软件的配置文件.md
tags: [印象笔记]
---

# Homebrew 技巧：使用 Mackup 快速备份 Mac 软件的配置文件

# Homebrew 技巧：使用 Mackup 快速备份 Mac 软件的配置文件 --- ![](.evernote-content/029136F8-67FC-4AC1-A39E-2E6886B0A
