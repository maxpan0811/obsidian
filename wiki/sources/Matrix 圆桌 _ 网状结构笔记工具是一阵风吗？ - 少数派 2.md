---
title: "Matrix 圆桌 _ 网状结构笔记工具是一阵风吗？ - 少数派 2"
type: source
created: 2026-07-06
updated: 2026-07-06
source_path: 印象笔记管理工具/Matrix 圆桌 _ 网状结构笔记工具是一阵风吗？ - 少数派 2.md
...
| 程序员 | @吕立青\_JimmyLv | ✅ | Roam Research |
...
![](.evernote-content/B8BF03D7-8222-4309-823C-8C7ACFE6CEB6/325E3B63-0ED3-4938-8081-90CADAA60AA6)
...
![](.evernote-content/B8BF03D7-8222-4309-823C-8C7ACFE6CEB6/79F46572-1A63-4BBB-BBA7-E85871811B80)
...
![](.evernote-content/B8BF03D7-8222-4309-823C-8C7ACFE6CEB6/1A41848D-5674-4DFE-A24E-9531ABBA8D90)

但是，如果我们只从单独页面去绘制「微观」的图片，又显得不够。

![](.evernote-content/B8BF03D7-8222-4309-823C-8C7ACFE6CEB6/35E64118-85D0-485B-9F51-7B863D32726F)
...
![](.evernote-content/B8BF03D7-8222-4309-823C-8C7ACFE6CEB6/AD39FD26-6B4A-4848-B707-BF10A8EECC14)
...
![](.evernote-content/B8BF03D7-8222-4309-823C-8C7ACFE6CEB6/A201A1BF-27C6-411A-95E0-84BBFF0322EB)
...
![](.evernote-content/B8BF03D7-8222-4309-823C-8C7ACFE6CEB6/6EBA787F-40E9-4881-BD58-A2C649F0A295)
...
![](.evernote-content/B8BF03D7-8222-4309-823C-8C7ACFE6CEB6/3DE7F63E-A09D-4F4C-B9CE-E800B6602448)
...
![](.evernote-content/B8BF03D7-8222-4309-823C-8C7ACFE6CEB6/606C6D75-B935-4337-959A-7EBE37466753)
...
![](.evernote-content/B8BF03D7-8222-4309-823C-8C7ACFE6CEB6/F96E2A07-01F1-43FB-AC12-8645DC5089B0)
...
![](.evernote-content/B8BF03D7-8222-4309-823C-8C7ACFE6CEB6/D8C4ABEA-B792-45FF-903A-A8386E4E8EE7)
...
![](.evernote-content/B8BF03D7-8222-4309-823C-8C7ACFE6CEB6/8FDA9215-3750-4231-B82C-D74763AF04E0)

而针对读书笔记，我在尝试结合共振日历（Resonance Calendar）和卡片盒笔记法（Zettelkasten Method）后，诞生了以下的模板：

![](.evernote-content/B8BF03D7-8222-4309-823C-8C7ACFE6CEB6/BB439BF4-5A48-4C2B-A572-97BBCBFDCFDD)

上半部分请见[Roam: Creating a Resonance Calendar in Roam Research](https://youtu.be/c_YfDJTvWv0)，下半部分则与卡片盒笔记法中的三种笔记类型相对应：直接摘抄（cuttings）、用自己的话概括（notes）、有再创造价值的信息（thougths）。

️ ：少数派的读者们对少楠也不陌生了，虽然你没有入坑网状结构笔记工具，但能分享一下自己在 Notion 中管理笔记的结构吗？

@少楠：我主要用 Notion 管理工作内容，包括产品设计，行业知识，思维方式，产品研究等，典型案例有 [互联网医院政策研究](https://www.notion.so/plidezus/abac37f88820424594e8bdc58fa8a3c5)；[交易平台研究](https://www.notion.so/plidezus/Marketplace-5eaea27d9cea446fafaba4781e95e8b4)；[电子表格的历史](https://www.notion.so/plidezus/2f752d52a7b840d78264261972feff29)。Notion 帮我解决了资料整理汇总、排版、分享批注、以及整个资料库的索引问题。

![](.evernote-content/B8BF03D7-8222-4309-823C-8C7ACFE6CEB6/493E12B3-009D-4803-A87C-6EDABEE84BC9)

此外，我还用 Flomo 来记录一些碎片化的想法（可以理解为一个有 tag 系统的 slack），因为许多零碎的想法如果开 notion 太慢了（笑），有些又不适合发到即刻等类似的社交平台，记事本又不好检索，所以就自己做了一个。（和朋友一起开发的，目前还是我们几个人在封测，有个 [DEMO](https://flomo.app/user/2)）

![](.evernote-content/B8BF03D7-8222-4309-823C-8C7ACFE6CEB6/4CC98CAA-05B8-4584-B4FA-55061644D9A9)

### 工作流

️ ：有没有朋友可以分享一下自己围绕网状结构笔记工具展开的工作流呢？

#### @idelem：围绕 day notes 展开的工作流
...
![](.evernote-content/B8BF03D7-8222-4309-823C-8C7ACFE6CEB6/B669406E-ABD1-4EB6-B198-38E67032A955)
...
![](.evernote-content/B8BF03D7-8222-4309-823C-8C7ACFE6CEB6/8B809C5A-F41E-454A-9872-24391B6D2E87)

@吕立青：把碎片知识变为结构化内容

从输入到输出的过程可以用下面这张图体现，图就是在 Roam 里面直接画的。

![](.evernote-content/B8BF03D7-8222-4309-823C-8C7ACFE6CEB6/1F9F4FEE-D054-4735-BA89-7907AF7AFDAD)
...
![](.evernote-content/B8BF03D7-8222-4309-823C-8C7ACFE6CEB6/3EE608A2-8C55-42E0-A530-F7DF31CD4DAF)
...
我自己是先开始用卡片做卡片笔记 (但做得不怎么好)，后来为了更好地管理笔记才开始用网络化笔记工具的。换句话说，我在这些工具上只做一件事，那就是撰写和管理（广义的）笔记，此外别无他用：我不会用它管理代办，也不会把它当成收藏夹，更不会用它写生活日记。在拙文[《Roam Research Report——理念与功能》](https://sspai.com/post/60588)里，我把这种划分粗略地梳理为下面这张示意图：

![](.evernote-content/B8BF03D7-8222-4309-823C-8C7ACFE6CEB6/F1569CDE-AE40-41BA-9AB5-B190C6681BDA)
...
1. 建立一个新的页面，并在上面写下我对这一话题的初步想法。
2. 开始针对性的研究，看看这个话题下都有哪些研究者 / 艺术家、有过哪些成果 / 作品。
3. 阅读第 2 步中找到的这些资料，挑选值得阅读的内容并撰写笔记。
4. 阅读笔记，思考并梳理出材料之间的关系与话题内在的结构。

4.1 发现了其他值得研究的话题，开设相应的页面，并写下初步想法及参考资料。

1. 调整第 1 步写下的话题，优化其表述、内容、论证、侧重点等等。
2. （偶然或特意）发现并阅读了新的内容，重复第 4、5 步。
3. 等自己觉得满意之后，开始撰写策展方案。
...
![](.evernote-content/B8BF03D7-8222-4309-823C-8C7ACFE6CEB6/06977C79-416B-46F9-99F4-3E6BB83DC5B1)
...
* 你会发现我的笔记几乎是线性的——它几乎堆叠在一起，即使跳转到其他页面也有逻辑可寻。而产生的内容却是网状的，他们通过链接和标签有意义地相互连接。所以我可以用线性的记录成本，来获得网状的知识结构。
* 这在传统的笔记应用中是很难做到的。试想一下在 OneNote 中记录同样的内容，该是一件多么耗费精力的事情。
* 当我想要关注到某个具体的方面时，我能够通过相应的维度，看到我每天所记录的变化、体会。
...
类似功能在不少领域其实都已经有了不错的应用，比如文献搜索工具 [Connected papers](https://www.connectedpapers.com/about) 就会根据不同文献间的引用关系和相关性提供更好的文献搜索体验。

![](.evernote-content/B8BF03D7-8222-4309-823C-8C7ACFE6CEB6/A9049404-E5F6-46A9-A7ED-0F63EE79AD41)

iOS 上的应用 WikiLinks 会通过图谱的形式展示与搜索内容相关的其它关键词。希望未来的该类笔记可以实现这样的功能。

@宽治：从知识管理的本质上来说，它们不能解决（也就是需要使用者自己通过思考来解决）的问题是：

1. 平衡笔记的[可理解性与可发现性](https://fortelabs.co/blog/progressive-summarization-a-practical-technique-for-designing-discoverable-notes#content:~:text=Making%20a%20note%20discoverable%20involves%20making,sure%20nothing%20falls%20through%20the%20cracks.)之间的张力。
...
* 不存在「最好的笔记工具」，不存在 the one note-taking tool to rule them all
* 不存在统一的知识体系，你只需要忠于你的大脑
* 笔记不是仓库，而是思考过程的媒介
...
如果想认真学习践行类似于 Zettelkasten 的卡片式信息管理方式，那就建议去使用 RoamResearch 或者 RemNote 从头开始完成一些内容的创作。如果你和我一样，愿意尝试新东西，想要参与一款工具从 0 到 1 的成长过程，不妨试试 [Wolai](https://www.wolai.com/product)。（Wolai 内测邀请码 RPTA2C3）
...
@玉树芝兰：有人告诉你Roam Research很贵，于是你可能早就在心里对它画了个叉。但不是这样的。如果你注册过了 Beta 版本，那么已创建的 Graph 可以一直免费用下去，功能上在目前没有任何限制；如果已经和 Beta 版失之交臂，也不必每个月花 15 美金，你可以从我的视频[《用 Roam Research 到底需要花多少钱？》](https://www.bilibili.com/s/video/BV16a4y1h74P)中了解一下资助申请办法，甚至有可能全免费使用~
...
@FKY：不急着使用的朋友也可以蹲一蹲 [Athens Research](https://github.com/athensresearch) 。它是一个正在开发中的开源的（不只是免费）网状结构笔记工具，从使用体验上可能会最接近 Roam，包括基于 Web、可以递归的双向链接、Tags、Block、TODO、Sidebar 等等。

@思考问题的熊：再推荐一下 [RemNote](https://www.remnote.io/homepage)。
...
吕立青：[从卡片链接到大脑联想，基于 Obsidian 的卡片盒笔记法实践](https://sspai.com/post/60802)

宽治：[Roam Research Report ——理念与功能](https://sspai.com/post/60588)

FKY：[在 Roam Research 全面收费之际，我有这些话想说](https://sspai.com/post/61144)

@idelem：Trilium：超高自由度的个人知识库 [基础篇](https://sspai.com/post/59739)、[进阶篇](https://sspai.com/post/59792)、[高级篇](https://sspai.com/post/61662)

@少楠：[用 Notion 实践 P.A.R.A 理论，重塑你的第二大脑](https://sspai.com/post/61459)

@思考问题的熊：[印象笔记入门进阶与避坑指南](https://sspai.com/post/47150)

另外，如果你对这种笔记方法感兴趣，也可以阅读社区中的优秀产出：[How to take smart notes，方法及工具](https://sspai.com/post/60466)

对于网状结构笔记工具，你还有什么问题和想法，欢迎在评论区进行分享~关于 Matrix 圆桌，你有什么想看各位作者讨论的内容，也欢迎踊跃发言~

---

[🌐 原始链接](https://sspai.com/post/61886)

[📎 在印象笔记中打开](evernote:///view/207087/s1/3bf787bb-d3ba-4554-8f2a-ed72d98638bd/3bf787bb-d3ba-4554-8f2a-ed72d98638bd/)
