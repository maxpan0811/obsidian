---
title: "OS X新手技巧_ 如何用计算器进行单位换算"
type: source
created: 2026-07-15
updated: 2026-07-15
source_path: 印象笔记管理工具/OS X新手技巧_ 如何用计算器进行单位换算.md
tags: [印象笔记]
---
...
　威锋网讯，你可能认为 OS X 中内置的计算器只能够提供“加减乘除”等简单操作，但其实它能够实现的比你想的要更多。你是否知道，Mac 上的计算器除了能够计数外，它还是一款功能齐全的单位换算器。  
  
　今天我们就来一同学习一下如何使用 Mac 自带的计算器来进行不同单位之间的换算。与此同时，或许你也能够抛下其它的第三方单位转换器 App 了。接下来就通过一个简单的例子来进行说明，资深用户可忽略。  
  
　如果你希望将 2847 英尺转换为英寸的话：  
