...
# 还在手动输入复杂的公式？7 款 LaTeX 实用工具帮你省下时间 --- 还在手动输入复杂的公式？7 款 LaTeX 实用工具帮你省下时间 ============================
...
![](.evernote-content/BEBE6957-E184-47CA-B6F1-C6CFB09C025D/9EF8E3F4-35E2-4F63-8069-F0B8BA22095B.gif)

圈出识别区域（操作动图来自 Mathpix 官网）

* 经过识别后，我们在菜单栏就可以得到相应的 LaTeX 源代码：

![](.evernote-content/BEBE6957-E184-47CA-B6F1-C6CFB09C025D/4F5FC666-432D-4C95-B935-00A3031C13B2.gif)
...
**推荐阅读：**[MyScript Nebo，用 Apple Pencil 做笔记的最佳搭档丨 App+1](https://sspai.com/post/35364)

![](.evernote-content/BEBE6957-E184-47CA-B6F1-C6CFB09C025D/9C8A34F2-8D83-4509-95E3-E42681DF34D4.png)
...
![](.evernote-content/BEBE6957-E184-47CA-B6F1-C6CFB09C025D/54E6FAFD-31B1-4CB9-99F7-A691813BD0D1.gif)

Detexify 利用触控板绘制公式（截取自官网视频）

除了 macOS 客户端，在 [Detexify 的官网](http://detexify.kirelabs.org/classify.html) 上面我们也可以直接使用它绘制 LaTeX 字符。

![](.evernote-content/BEBE6957-E184-47CA-B6F1-C6CFB09C025D/B7F376D5-BBF7-4EFD-AB88-38EB6FFF9075.png)
...
![](.evernote-content/BEBE6957-E184-47CA-B6F1-C6CFB09C025D/F880C82E-7E07-49AC-95D1-5EF0753CAD6B.png)
...
![](.evernote-content/BEBE6957-E184-47CA-B6F1-C6CFB09C025D/00035BFE-FCDA-4CF7-8598-2499DCDECDA4.png)

利用 Grapher 绘制方程图像

在 Grapher 的公式编辑区域右上角，我们可以唤出图形化的公式编辑器。我们可以利用它编写我们需要绘制为图像的函数方程，直观方便。

![](.evernote-content/BEBE6957-E184-47CA-B6F1-C6CFB09C025D/925D74ED-8546-4B19-A78F-53E136FC7F55.png)

图形化的公式编辑界面

除了绘制函数方程组的图像以外，我们在绘制过程中所使用到的函数方程公式等等，都可以直接以 LaTeX 的形式导出。我们选中所需要的公式，单击右键，即可看到拷贝为 LaTeX 表达式的选项。

![](.evernote-content/BEBE6957-E184-47CA-B6F1-C6CFB09C025D/7FCACDFA-3FB2-4B7D-B0C8-BA0EE9FA931D.png)
...
![](.evernote-content/BEBE6957-E184-47CA-B6F1-C6CFB09C025D/715685C8-5B78-4C39-A0E0-5A1344847653.png)
...
![](.evernote-content/BEBE6957-E184-47CA-B6F1-C6CFB09C025D/EDA496F6-83DD-432F-BBF3-E1FF90885511.png)
...
![](.evernote-content/BEBE6957-E184-47CA-B6F1-C6CFB09C025D/A389F9A0-7DCE-405A-BCE4-8CEE81FD071F.png)
...
[🌐 原始链接](https://sspai.com/post/54283)

[📎 在印象笔记中打开](evernote:///view/207087/s1/6576d4f7-ddb1-448f-add6-4f27e6d907b2/6576d4f7-ddb1-448f-add6-4f27e6d907b2/)