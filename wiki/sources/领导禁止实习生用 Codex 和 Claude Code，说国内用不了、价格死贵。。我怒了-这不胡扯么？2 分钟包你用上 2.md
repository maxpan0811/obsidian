---
title: 领导禁止实习生用 Codex 和 Claude Code，说国内用不了、价格死贵。。我怒了：这不胡扯么？2 分钟包你用上 2
type: source
created: 2026-07-06
updated: 2026-07-06
source_path: 印象笔记管理工具/领导禁止实习生用 Codex 和 Claude Code，说国内用不了、价格死贵。。我怒了：这不胡扯么？2 分钟包你用上 2.md
