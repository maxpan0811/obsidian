---
title: 为什么我把笔记应用从 Evernote 迁移到了 DEVONthink？ 2
type: source
created: 2026-07-06
updated: 2026-07-06
source_path: 印象笔记管理工具/为什么我把笔记应用从 Evernote 迁移到了 DEVONthink？ 2.md
...
![](.evernote-content/FE114DEF-D19D-437B-BD54-96030B203947/9368F3F1-1EAF-4A9E-9710-691B189ABC96.png)Evernote 裁剪前后的网页对比
...
一些常用的文本编辑功能，如「搜索和替换」，在 Evernote 中也一直是缺失的。之前我可以使用其他文本编辑器如 BBEdit 编辑笔记的源代码 (ENML) 来实现 Evernote 中缺失的功能。为了快速打开笔记其对应的 ENML 文件，我制作了一个 Keyboard Maestro [Macro](https://github.com/OscarGong/My-Apple-Script/blob/master/Evernote/Open%20Current%20Note%27s%20ENML/Open%20Current%20Note%27s%20ENML.scpt "Macro")。但是最近版本中，笔记的 ENML 存放位置经常发生变动，并且没有相应的文档可查询，导致每次变化时我都要花费大量的时间摸索修改这个 Macro。

如果 ENML 对 Evernote 从一而终，一直是一等公民也还好，但是 Evernote 不希望用户接触到 ENML，用户使用的 Evernote 笔记编辑器操纵的是 ENML 渲染成的富文本。同时 Evernote 的本地自动化能力有限，虽然[支持 Apple Script](http://sspai.com/post/Mac%20-%20Evernote%20Developers%0Ahttps://dev.evernote.com/doc/articles/applescript.php%0A%0A "支持 Apple Script")，但是功能十分很少：

![](.evernote-content/FE114DEF-D19D-437B-BD54-96030B203947/C78808EB-3D58-49D7-BAF6-E2B03BB0D0EB.png)二者自动化能力比较

这一切加起来使得在使用 Evernote 时，大部分时间都在点鼠标点鼠标，调整格式。如果 Evernote 能够支持 Markdown 在一定程度上可以解决这个问题，虽然Evernote 在2015 年就[公布](https://blog.evernote.com/blog/2015/09/22/the-future-of-writing-in-evernote/ "公布") 将开启 Markdown 内测，但是 2018 年了大家依旧没能用上。
...
![](.evernote-content/FE114DEF-D19D-437B-BD54-96030B203947/13A4497D-EAA7-4260-9EDC-86D7EB81EC8C.png)使用 BBEdit 高亮代码
...
![](.evernote-content/FE114DEF-D19D-437B-BD54-96030B203947/9884F2C8-E999-4E05-9572-83DEA24F93D4.png)一篇无复杂格式的笔记
...
![](.evernote-content/FE114DEF-D19D-437B-BD54-96030B203947/2674F4A6-7B94-46BA-9C78-A687D4B9A511.png)升级到 Pro
...
![](.evernote-content/FE114DEF-D19D-437B-BD54-96030B203947/38A511EC-77EF-4EEB-B844-7390B6CEBF49.png)Mac 与 iOS DEVONthink 的同步方式
...
![](.evernote-content/FE114DEF-D19D-437B-BD54-96030B203947/64A4B32E-D22E-4617-8501-47C67D340C9C.png)BOX 同步

* **User Name** 与 **Password** 就是 BOX 的用户名和密码，如果使用 Dropbox 因为 Dropbox 使用 OAuth 2 验证，会弹出网页进行授权。
* **Sync Store Name** ，在云端部分 DEVONthink 数据的名字。虽然在本地，DEVONthink 的数据是以一个个 `*.dtBase2` 文件存储的；但是在云端，所有的 `dtBase2` 文件会被打包成一个 `dtCloud`文件。当不同平台的 DEVONthink 之间同步时，使用相同的云平台，输入**相同的** `Sync Store Name`，就会同步同样的数据。 ![](.evernote-content/FE114DEF-D19D-437B-BD54-96030B203947/F03022E0-4EF5-4C27-844B-C9EB507B145A.png)
...
DEVONthink 支持直接导入单篇从 Evernote 导出的 `enex` 笔记文件，导入后为Formatted Note；或者如果你打算 all-in DEVONthink，其也支持直接导入 Evernote 的整个数据库：`File - Import - Notes from Evernote…`  
同时 DEVONthink 也支持导入 Notes 的数据，方法与 Evernote 类似。

![](.evernote-content/FE114DEF-D19D-437B-BD54-96030B203947/850D7FF2-DD7B-4D93-B4E5-F2AFFB3D725F.png)从 Evernote 导入的一个笔记本
...
![](.evernote-content/FE114DEF-D19D-437B-BD54-96030B203947/E648F20C-CE7F-47DE-B089-A69F8F2EBBA6.png)Keyboard Maestro
...
![](.evernote-content/FE114DEF-D19D-437B-BD54-96030B203947/9A00A481-6176-4F83-B80E-70462C0691DF.png)导入与索引
...
![](.evernote-content/FE114DEF-D19D-437B-BD54-96030B203947/152A1AF2-B04F-4BB5-B2E3-A8AE3833804D.jpg)Exclude Groups from Tagging
...
![](.evernote-content/FE114DEF-D19D-437B-BD54-96030B203947/A30431DB-92F9-4837-9905-720A397D03D3.png)Tags 为蓝色；Groups 为灰色

此时如果我按下快捷键 `⌃Control - ↩Return` 为某个文件标记了多个 Groups 后：

![](.evernote-content/FE114DEF-D19D-437B-BD54-96030B203947/368611C8-3C3F-4B7B-A524-FB74716F7038.png)alter to replicant
...
**Replicate** 动作会创建 replicant，replicant 类似 Finder 中的 alias 概念，但是并不一样，alias 有 original 和 aliases 之分。但是replicant 没有这个分别，replicant 也并不是复制了一份，各个 replicant 其实是一个文件，修改一处，其余也会被修改。
...
![](.evernote-content/FE114DEF-D19D-437B-BD54-96030B203947/FF231EBA-38C6-43EB-A54D-356AE399D584.png)Replicant 与 Duplicate
...
一个很重要的因素是：DEVONthink 引以为傲的 AI 技术中的 Auto Group 和 Classify (`Data -> See Also & Classify`) ，只能把文档分类到不同的 Group 中，而不能对其打不同的标签 。（尽管 Auto Group 实际效果还不错，但是对我来说还是营销噱头的感觉大一些，官方甚至自己也用「AI技术」做调侃，如[这篇四月一号的博文](https://blog.devontechnologies.com/2017/04/awareness/ "这篇四月一号的博文")。）

![](.evernote-content/FE114DEF-D19D-437B-BD54-96030B203947/DDF4021C-BF04-4596-86DE-83A592C60AC7.png)Classify See Also
...
![](.evernote-content/FE114DEF-D19D-437B-BD54-96030B203947/4EBBADD2-12C2-4BF9-8BC9-656FFF16BC3D.jpg)
...
[笔记格式](https://www.amazon.com/Power-Habit-What-Life-Business/dp/081298160X "<The Power of Habit: Why We Do What We Do in Life and Business>\"><The Power of Habit: Why We Do What We Do in Life and Business></a> 这本书里有一些很有趣的例子，关于大公司拥有了大量数据以后，人们的自由意志是如何被操纵的。</p> <h3 id=")
...
![](.evernote-content/FE114DEF-D19D-437B-BD54-96030B203947/5DC6D843-3356-4F12-BF20-A7725C65A77D.png)DEVONthink Format
...
![](.evernote-content/FE114DEF-D19D-437B-BD54-96030B203947/F08747D0-93D4-4308-AAB7-B13D57C464C8.png)Context
...
![](.evernote-content/FE114DEF-D19D-437B-BD54-96030B203947/DDF4021C-BF04-4596-86DE-83A592C60AC7.png)DEVONthink AI
...
![](.evernote-content/FE114DEF-D19D-437B-BD54-96030B203947/771FD31D-A190-497F-955D-12E423FA311B.png)Evernote Notes History
...
![](.evernote-content/FE114DEF-D19D-437B-BD54-96030B203947/1E703579-D383-471A-835E-7150EBE2584C.png)DEVONthink Sorter
...
![](.evernote-content/FE114DEF-D19D-437B-BD54-96030B203947/730B815D-F1C6-43AB-BB57-45D2885FEB5D.png)DEVONthink Global Inbox
...
![](.evernote-content/FE114DEF-D19D-437B-BD54-96030B203947/0DF0813E-982B-4A75-818C-16F835AB4006.png)DEVONthink Clipper 和 Bookmarklets
...
![](.evernote-content/FE114DEF-D19D-437B-BD54-96030B203947/978D11FE-55F7-4168-A92F-33D19913E3EA.png)小书签的代码
...
![](.evernote-content/FE114DEF-D19D-437B-BD54-96030B203947/2999C2E6-6655-4E2E-B8BF-91F42C5E06FF.png)DEVONthink Web Browser
...
![](.evernote-content/FE114DEF-D19D-437B-BD54-96030B203947/7DF2ADCD-9CAE-423B-B03F-E3AD371D20F8.png)比较
...
之前我在 [Twitter](http://sspai.com/post/%5Bhttps://twitter.com/oscargong1995/status/970326580424667137%5D "Twitter") 上说，Safari 的「Export as PDF」是效果最好的将网页保存为 PDF 的工具；现在我认为 DEVONthink 才是这个领域最好的工具。
...
![](.evernote-content/FE114DEF-D19D-437B-BD54-96030B203947/7B5848EB-83C7-4D9A-86F0-9E654AF940B6.png)Open in DEVONthink Macro
...
![](.evernote-content/FE114DEF-D19D-437B-BD54-96030B203947/3CC0D7F9-8A29-4462-8E94-F204DDF13671.png)Quick Search in DEVONthink
...
* [DEVONthink Part 4 - Duplicates, Replicants and Bookmarks — MyProductiveMac](http://sspai.com/post/%5Bhttp://www.myproductivemac.com/blog/devonthink-part-4-duplicates-replicants-and-bookmarks19102015%5D "DEVONthink Part 4 - Duplicates, Replicants and Bookmarks — MyProductiveMac")
