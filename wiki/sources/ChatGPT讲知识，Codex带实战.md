---
title: ChatGPT讲知识，Codex带实战
type: source
created: 2026-06-27
updated: 2026-06-27
source_path: 印象笔记管理工具/ChatGPT讲知识，Codex带实战.md
...
让 Codex 帮你搭建一个「可运行、可迭代、可测试、可复盘」的学习仓库。
...
“请根据 progress.md 安排今天学习任务。”

然后完成：

学习 → 练习 → 输出 → 测验 → 复盘

30天后得到的不是一堆收藏夹资料，而是一套属于自己的知识资产库。
