---
title: 国内用 Claude Code 的终极方案（DeepSeek 后端）
type: source
created: 2026-06-08
updated: 2026-06-08
sources: [https://mp.weixin.qq.com/s?__biz=MzI1NDczNTAwMA==&mid=224758...]
source_path: 印象笔记管理工具/领导禁止实习生用 Codex 和 Claude Code，国内用不了、价格死贵。。。我怒了：这不胡扯么？2 分钟包你用上.html
tags: [claude-code, deepseek, domestic, tutorial, codex]
updated: 2026-06-27
---
...
guid: 3fded1e1-7aa8-41e2-bf2a-afd832ee147a
---
...
![](attachments/27bd31c012c34896.png)
...
![](attachments/9bbddcb0a2975616.png)

Mac 用户推荐直接用 Homebrew 一行命令安装，装完直接就能用：

brew install --cask cc-switch

![](attachments/4a0e8f607014a1f0.png)
...
![](attachments/91fe0b97db7b5500.png)
...
![](attachments/f8d1d650808de2d2.png)
...
![](attachments/3f66f2ae310db884.png)

在预设的模型供应商列表里选择 **DeepSeek**：

![](attachments/72acd82fe710d760.png)

接下来填写刚才在 DeepSeek 开放平台创建好的 API Key：

![](attachments/5889cb7f78cd0e93.png)
...
![](attachments/6f1150a17f365b07.png)
...
![](attachments/c2c034ab486d2489.png)
...
![](attachments/34245137c3a43826.png)
...
![](attachments/47d998a225572d65.png)

如果想改回来，反向操作即可，把路由关掉、再启用默认配置就行：

![](attachments/fc3c4bff71746225.png)
