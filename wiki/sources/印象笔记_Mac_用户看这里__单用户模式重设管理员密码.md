---
title: "Mac 用户看这里_ 单用户模式重设管理员密码"
type: source
created: 2026-07-15
updated: 2026-07-15
source_path: 印象笔记管理工具/Mac 用户看这里_ 单用户模式重设管理员密码.md
tags: [印象笔记]
---

# Mac 用户看这里_ 单用户模式重设管理员密码

# Mac 用户看这里: 单用户模式重设管理员密码 --- 近日，锋友 [langren34](http://bbs.feng.com/forum.php?mod=viewthread&tid=105
