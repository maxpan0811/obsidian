---
title: 【三万字长文】量子物理学家是如何使用 Anki 的？ 2
type: source
created: 2026-07-06
updated: 2026-07-06
source_path: 印象笔记管理工具/【三万字长文】量子物理学家是如何使用 Anki 的？ 2.md
...
[mmjang](https://www.zhihu.com/people/12a4ef)
...
[@锋记](https://www.zhihu.com/people/f2b2c69cf1f78b02ad4b4e276dba5db5)
...
和原文一样，本文以 [CC BY-SA 3.0 协议](https://link.zhihu.com/?target=https%3A//creativecommons.org/licenses/by-sa/3.0/deed.zh)发布。
...
这只是用计算机增强人类记忆的许多尝试之一。从 memex 到 Web， 再到 [org-mode](https://link.zhihu.com/?target=https%3A//orgmode.org/)、[Project Xanadu](https://link.zhihu.com/?target=https%3A//en.wikipedia.org/wiki/Project_Xanadu) 和[为个人全部思想构建导图](https://link.zhihu.com/?target=https%3A//users.speakeasy.net/~lion/nb/book.pdf)的尝试：记忆增强是对计算机行业极其有推动力的愿景。
...
兴奋归兴奋，写这样的文章却会是不容易的。比起一般的新闻报道，它要求对 AlphaGo 技术细节有更深入的理解。好在我对神经网络还是有些了解的 —— 我写过一本[相关书籍](https://link.zhihu.com/?target=http%3A//neuralnetworksanddeeplearning.com/)。但是我对围棋一窍不通，也不懂 AlphaGo 用到的很多叫做强化学习的思想。我得从头开始学，要想写出好文章我得真正理解文章背后的技术内容。
...
顺便，原子化的问题并不一定就不能包含复杂且高阶的概念。考虑下面这个来自广义相对论的问题：“[罗伯森－沃克度规](https://link.zhihu.com/?target=http%3A//dict.cn/%25E7%25BD%2597%25E4%25BC%25AF%25E6%25A3%25AE%25EF%25BC%258D%25E6%25B2%2583%25E5%2585%258B%25E5%25BA%25A6%25E8%25A7%2584)中 ![](.evernote-content/9961A433-882D-46CD-8C0A-B8AD1482F62A/A0CD3BC0-BBC1-4BD9-A96E-C2676B7D9A6D) 项是什么？” 答案：“ ![](.evernote-content/9961A433-882D-46CD-8C0A-B8AD1482F62A/7FD0971B-7296-459E-8822-5DCDD114D80E) ”。好了，除非你学过广义相对论，这个问题看上去会很深奥。这是个复杂且综合的提问，它假设你已经知道什么是罗伯森－沃克度规， ![](.evernote-content/9961A433-882D-46CD-8C0A-B8AD1482F62A/A0CD3BC0-BBC1-4BD9-A96E-C2676B7D9A6D) 代表什么， ![](.evernote-content/9961A433-882D-46CD-8C0A-B8AD1482F62A/F2CDE8F5-C1AF-409D-93C1-A40663B92EAA) 代表什么，等等。但是，在已有背景知识的条件下，这却是一对非常原子化的问题和答案。
...
“如果个人计算机真的是一种\_\_\_\_,那么

其应用将会改变\_\_\_\_的\_\_\_\_\_”
...
Adelson 错觉又称为 \_\_\_\_\_\_ 错觉。

（答案：棋盘阴影）

为什么不使用更多的 Anki 功能呢？部分原因是仅仅使用核心功能我就已经获得巨大的好处了。更进一步，用好这一点核心功能就已经很花功夫了。篮球和篮筐是简单的装备，但你可以花一辈子去学会用好他们。同样的，基本 Anki 操作可以发展到很高的程度。所以我专注于学会用好这些基础功能。
...
编程接口、书籍、视频、研讨会、对话、网页、事件、地点：几乎所有之前关于 Anki 论文的讨论都可以应用到其他资源上。这里有一些小贴士。关于编程接口的讨论我放到了附录里，如果感兴趣可以去看（译注：附录请看[原文](https://link.zhihu.com/?target=http%3A//augmentingcognition.com/ltm.html)）。
...
答案是 “是”。就其本身来说，无伤大雅。但是如果能深入阐述提问里包含的思想会帮助更大。可以加个问题提问哪些图模型的分区函数是难以处理的。可以给出一个难以处理的图模型的例子吗？分区函数的计算难以处理到底是什么意思？进行问题重构时，应当优先考虑重构判断题。
...
[Gwern Branwen](https://link.zhihu.com/?target=https%3A//www.gwern.net/Spaced-repetition), [Sasha Laundy](https://link.zhihu.com/?target=https%3A//sasha.wtf/anki-post-1/amp/) 和 [Derek Sivers](https://link.zhihu.com/?target=https%3A//sivers.org/srs) 的文章是导致我当初被 Anki 迷住的部分原因。感谢 Andy Matuschak、Kevin Simler、Mason Hartman 和 Robert Ochshorn 关于本文激发灵感的讨论。尤其感谢 Andy Matuschak 充满思想且愉悦的对话，特别是他指出把 Anki 作为一项协助理解的精湛技巧而不仅仅是记忆知识点的方法的观点是多么非同寻常。最后，谢谢所有在推特上回复我 [Anki 帖子](https://link.zhihu.com/?target=https%3A//twitter.com/michael_nielsen/status/957763229454774272)的人。
