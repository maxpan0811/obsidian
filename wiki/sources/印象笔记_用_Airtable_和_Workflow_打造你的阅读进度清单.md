---
title: "用 Airtable 和 Workflow 打造你的阅读进度清单"
type: source
created: 2026-07-15
updated: 2026-07-15
source_path: 印象笔记管理工具/用 Airtable 和 Workflow 打造你的阅读进度清单.md
tags: [印象笔记]
---

# 用 Airtable 和 Workflow 打造你的阅读进度清单

# 用 Airtable 和 Workflow 打造你的阅读进度清单 --- 自从接触到了 [Airtable](https://airtable.com/) 和 [Workflow](https:/
