...
# 让 Windows 11 更好用，我用这些设置、插件把它「打磨」了一遍 --- 速读摘要 这样可以避免微软账户的一些设置，但也会导致一些功能无法使用。在任务栏设置中，我们要做的第一件事就是把塞满广
...
这样可以避免微软账户的一些设置，但也会导致一些功能无法使用。在任务栏设置中，我们要做的第一件事就是把塞满广告和各种无用信息的小组件整体关闭，然后根据个人习惯调整其他设置，比如我会将搜索仅显示图标、任务栏左对齐、永远合并任务栏按钮。虽然前面系统设置部分已经提到部分调整手段，但是这些调整往往需要手动修改注册表等隐藏更深的手段。Power plan switcher可以在系统托盘中切换电源计划，支持快捷键、自动切换等功能。

原文约1.1 万字|图片19张|建议阅读23分钟|[评价反馈](https://static.app.yinxiang.com/embedded-web/clipper/#/Evaluating?d=2024-09-26&nu=75d10010-1f43-42c0-b4be-9e87f610a14c&fr=myyxbj&ud=328ef&v=2&sig=60AA71E91B6A5C91FB005F29B15A980C)

原文链接: [http://mp.weixin.qq.com/s?\_\_biz=MzU4Mjg3MDAyMQ==&mid=2247581...](http://mp.weixin.qq.com/s?__biz=MzU4Mjg3MDAyMQ==&mid=2247581125&idx=2&sn=358e1a24df9a14819d16237fce8dd15f&chksm=fcf7361190e35fec7abec51c5dbcfe138449568093a4382f34e8d959d40ee60ee4f245ae31ec&mpshare=1&scene=1&srcid=0926h27H37BQMacZtGR4WkZ0&sharer_shareinfo=8309b4dff2735f6a0af9b432aac7e193&sharer_shareinfo_first=8309b4dff2735f6a0af9b432aac7e193#rd)

**编注**：我们会不定期挑选 Matrix 最优质的文章，展示来自用户的最真实的体验和观点。 文章代表作者个人观点，少数派仅对标题和排版略作修改。
...
除了预装系统的 OEM 设备，新设备至少第一次的完整的更新是必要的，这些更新包含正常使用的驱动等。如果 Windows 更新无法为你下载安装特定版本的驱动，你也可以前往对应设备厂商的官网手动下载安装。
...
+ 定位到 HKEY\_LOCAL\_MACHINE\SOFTWARE\Policies\Microsoft\Windows
...
![](.evernote-content/8D21B5BD-701B-4E8F-ABB7-F25814BF9FBF/A3E38DB1-E9FA-4B34-BCEC-C7B2E9AC9E3C.jpg)

* 定位到 HKEY\_LOCAL\_MACHINE\SOFTWARE\Microsoft\WindowsUpdate\UX\Settings
...
**reg add "HKEY\_LOCAL\_MACHINE\SOFTWARE\Microsoft\WindowsUpdate\UX\Settings" /v FlightSettingsMaxPauseDays /t reg\_dword /d 35 /f**
...
![](.evernote-content/8D21B5BD-701B-4E8F-ABB7-F25814BF9FBF/B3ED1749-B268-47A3-A44A-64B98FEA0892.jpg)

在任务栏设置中，我们要做的第一件事就是把塞满广告和各种无用信息的小组件整体关闭，然后根据个人习惯调整其他设置，比如我会将搜索仅显示图标、任务栏左对齐、永远合并任务栏按钮。

![](.evernote-content/8D21B5BD-701B-4E8F-ABB7-F25814BF9FBF/3CB47972-CF30-4BBC-BE42-EAB5D8C22FE2.jpg)

在开始菜单设置中，记得关掉第一面的所有推荐内容，并在「文件夹」中打开设置方便快速进入。

![](.evernote-content/8D21B5BD-701B-4E8F-ABB7-F25814BF9FBF/7A34933C-8CB7-4573-AF37-A8742EAB669E.jpg)

搜索栏在任务栏中的开始菜单附近，但是它的设置项目却在「隐私和安全性 > 搜索权限」中。而微软也往此处插入了一些「推荐内容」，需要在关闭设置项目最后的「显示搜索要点」。

![](.evernote-content/8D21B5BD-701B-4E8F-ABB7-F25814BF9FBF/6F0F597D-5E7C-4534-86CB-A6B8F963748A.jpg)
...
![](.evernote-content/8D21B5BD-701B-4E8F-ABB7-F25814BF9FBF/A6272D4C-6487-40F4-98C7-E2097A49958A.jpg)
...
* 注册表编辑器定位到 Computer\HKEY\_CURRENT\_USER\SOFTWARE\CLASSES\CLSID\
...
* 注册表编辑器定位到 HKEY\_CURRENT\_USER\Software\Microsoft\Windows\CurrentVersion\Explorer\HideDesktopIcons\NewStartPanel
* 新建 DWORD(32-bit) Value 命名为 {2cc5ca98-6485-489a-920e-b3e88a6ccce3} 并赋值 1

![](.evernote-content/8D21B5BD-701B-4E8F-ABB7-F25814BF9FBF/F6566013-2DE9-4509-9B69-78053397F632.jpg)
...
![](.evernote-content/8D21B5BD-701B-4E8F-ABB7-F25814BF9FBF/2CB2B148-9506-47DB-8097-D8EBDFA5C5DE.jpg)
...
Windows 的色彩管理仍是一个相对混乱的领域，短期内是不指望能和 macOS 相提并论。但是 Windows 11 还是比前代 Windows 10 在 HDR 支持上有明显改进，至少算是过了及格线。
...
![](.evernote-content/8D21B5BD-701B-4E8F-ABB7-F25814BF9FBF/30FF4196-B11A-42A3-BD12-4A41CF9E13B3.jpg)
...
早在去年 UP 主 @开心的托尔酱 在视频《关于 Windows 系统对AMD的负优化—异类线程调度》就有提到这个问题。而最近 AMD 在社区更新了关于 Zen 5 游戏性能提升远不及理论的回应，宣布 Windows 11 24H2 将通过优化「branch prediction」 来提升 AMD Zen3/4/5 系列处理器的性能表现，部分游戏甚至有 10% 以上提升，要知道 Zen 5 由于相较于前代提升过于微妙有被戏称「Zen 5%」，更有特例 5700X3D 在 Windows 11 上性能表现比 Windows 10 差 15%……该说锐龙 CPU 首发一如既往地一言难尽呢、还是说与 Windows 合作不够紧密呢？
...
![](.evernote-content/8D21B5BD-701B-4E8F-ABB7-F25814BF9FBF/FB6E3029-362A-4904-B0BC-A3E8CD1FF162.jpg)
...
![](.evernote-content/8D21B5BD-701B-4E8F-ABB7-F25814BF9FBF/36851A90-D187-4896-924E-B9D45A185D48.jpg)
...
* Microsoft Store：https://www.microsoft.com/en-us/store/p/powerplanswitcher/9nblggh556l3

开源项目 Power plan switcher 可以在系统托盘中切换电源计划，支持快捷键、自动切换等功能。

![](.evernote-content/8D21B5BD-701B-4E8F-ABB7-F25814BF9FBF/2FAF041C-64E9-422D-B6B1-58A1CD06E9F3.jpg)
...
同时还有诸如 Color Picker、Image Resizer、Text Extractor 等一众小工具，让你免去管理一堆小工具的烦恼、也减少众多工具中出现某几个断更的风险。PowerToys 也有丰富的 第三方插件，例如 PowerTranslator 在 PowerToys Run 中直接翻译文本、EverythingPowerToys 在 PowerToys Run 中通过 Everything 检索文件、ChatGPTPowerToys 在 PowerToys Run 中调用 ChatGPT、PowerToys-Run-Spotify 在 PowerToys Run 中让 Spotify 放歌等等。
...
#SingleInstance ForceSetCapsLockState, AlwaysOffCapslock::Send {Blind}{RCtrl Down}{RAlt Down}{RShift Down}KeyWait, CapsLockSend {vkXXscXXX}{RShift Up}{RAlt Up}{RCtrl Up}If (A\_PriorKey = "CapsLock"){Send {Blind}{LWin Down}{Space Down}{Space Up}{LWin Up}}Return+CapsLock::SetCapsLockState % GetKeyState("CapsLock","T") ? "Off" : "On"
...
这催生了 Windows 同名第三方开源插件 QuickLook，行为几乎与 macOS Quick Look 一致，通过空格快速预览，同时支持通过引入插件的插件形式支持预览 markdown、jupyter notebook、电子书等更多格式文件，并且支持在 Directory Opus、Files、OneCommander 等第三方文件管理器中使用。

**▍****ThreeFingerDragOnWindows - 触控板三指拖拽**

* GitHub：https://github.com/ClementGre/ThreeFingerDragOnWindows
...
* 官网：https://schinagl.priv.at/nt/hardlinkshellext/linkshellextension.html
...
特别注意，少数派文章中介绍的「中键拖动」快速创建链接操作不适用于 Windows 11，正确操作应当修改为使用**右键**拖动。
...
![](.evernote-content/8D21B5BD-701B-4E8F-ABB7-F25814BF9FBF/02CE97CC-B766-4867-BCD0-9B375309823C.jpg)![](.evernote-content/8D21B5BD-701B-4E8F-ABB7-F25814BF9FBF/93DCE1CA-66E4-4F7E-B738-A7D8E485E2D5.jpg)

原文链接：

https://sspai.com/post/92064?utm\_source=wechat&utm\_medium=social
...
[🌐 原始链接](http://mp.weixin.qq.com/s?__biz=MzU4Mjg3MDAyMQ==&mid=2247581125&idx=2&sn=358e1a24df9a14819d16237fce8dd15f&chksm=fcf7361190e35fec7abec51c5dbcfe138449568093a4382f34e8d959d40ee60ee4f245ae31ec&mpshare=1&scene=1&srcid=0926h27H37BQMacZtGR4WkZ0&sharer_shareinfo=8309b4dff2735f6a0af9b432aac7e193&sharer_shareinfo_first=8309b4dff2735f6a0af9b432aac7e193#rd)

[📎 在印象笔记中打开](evernote:///view/207087/s1/d20e07bf-958e-4890-9380-e193524ef04c/d20e07bf-958e-4890-9380-e193524ef04c/)