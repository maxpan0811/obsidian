---
title: "加更 10：强大和易用并存的时间记录应用：Timemator - 少数派 2"
type: source
created: 2026-07-06
updated: 2026-07-06
source_path: 印象笔记管理工具/加更 10：强大和易用并存的时间记录应用：Timemator - 少数派 2.md
tags: [evernote, impression, yinxiang]
---

# 加更 10：强大和易用并存的时间记录应用：Timemator - 少数派
...
原文约 4941 字 | 图片 26 张 | 建议阅读 9 分钟

![](/images/file-generic.png)

![](.evernote-content/BD23B315-98E0-4D4C-86E1-D8793AB67C93/6BF4BA0F-EDF8-4CB7-83AC-84C3EC7FB5F0.png)
...
![](.evernote-content/BD23B315-98E0-4D4C-86E1-D8793AB67C93/F6485BDE-3C85-4FA0-A6E6-831D7B4D634F.png)

不同于其他时间记录工具，Timemator 是一个状态栏程序，它没有独立的主窗口界面，所有操作都通过点击状态栏图标弹出的小窗口实现。因此你可以在任何时候从状态栏快速操作它。

![](.evernote-content/BD23B315-98E0-4D4C-86E1-D8793AB67C93/2EA08E7A-AD01-45EB-9A17-A8C55BA57A39.png)

Timemator 的使用流程非常简单：你只需要点击左下角的「+」添加时间事项或文件夹，再点击事项左侧的开始按钮就可以启动计时。在积累了一些记录之后，点击界面底部的「Reports」按钮打开统计功能，即可查看自己的时间统计报告。

![](.evernote-content/BD23B315-98E0-4D4C-86E1-D8793AB67C93/80CF67AB-B80B-4973-A208-6FB3E17F543E.gif)
...
![](.evernote-content/BD23B315-98E0-4D4C-86E1-D8793AB67C93/2AA9EF9F-AAD3-485C-B90C-A99E4A2BD331.gif)
...
![](.evernote-content/BD23B315-98E0-4D4C-86E1-D8793AB67C93/EC371047-A2CF-4CEA-85DA-5A0F3D86B90E.png)
...
![](.evernote-content/BD23B315-98E0-4D4C-86E1-D8793AB67C93/4F67CC8A-7001-40D1-A172-BC88C7A0BEC7.png)

Timemator 允许我们通过逻辑关系建立多个条件来匹配事项，设置也非常简单：只需要在主页事项右边的「闪电」按钮就可以进入，也可以在任务上右键选择「Edit Rules」。

![](.evernote-content/BD23B315-98E0-4D4C-86E1-D8793AB67C93/B4563114-3A15-4A4F-908C-7F5204066D08.png)
...
![](.evernote-content/BD23B315-98E0-4D4C-86E1-D8793AB67C93/0699F1D3-6ECE-4E0C-94A9-9C2A64C2BA06.png)

下图是创建一个浏览少数派网站的规则，为了能记录下所有少数派的页面，可以指定访问的 URL 包含「sspai」关键词，这样基本所有少数派相关的页面都能记录到。

![](.evernote-content/BD23B315-98E0-4D4C-86E1-D8793AB67C93/838F77E7-D425-4407-9D97-256A4FDCA74E.gif)

如果某个事项可以被多个操作触发，则可以创建多条规则，只要满足其中一条，即可触发自动记录。这是我为主工作设置的匹配事项，当打开工作相关的程序、文件和网页时，都会启动计时。

![](.evernote-content/BD23B315-98E0-4D4C-86E1-D8793AB67C93/C712EDBF-A648-4EC9-9E6A-A8B83E89C9F2.png)
...
![](.evernote-content/BD23B315-98E0-4D4C-86E1-D8793AB67C93/C32A6CEA-8251-44D3-B672-3770ECD2EADA.png)

一切设置好后，自动记录就会开始工作，不需要额外的点击或其他操作。

值得注意的是，如果当前手动开启了一个计时任务时，自动记录不会立刻开始。直到手动关闭当前的计时任务之后，Timemator 才会启动自动记录。

![](.evernote-content/BD23B315-98E0-4D4C-86E1-D8793AB67C93/4F9F3472-3FFB-49EF-A211-CE9C3E77D8D6.gif)

如果你想临时停止某个规则，则可以在其激活的时候手动暂停关闭它。

![](.evernote-content/BD23B315-98E0-4D4C-86E1-D8793AB67C93/26F6BC93-8AED-4B67-88A9-720DB4B370D1.gif)
...
![](.evernote-content/BD23B315-98E0-4D4C-86E1-D8793AB67C93/853F279F-AA51-48BE-A59C-D70810BCC295.gif)
...
[上一期](https://sspai.com/post/78721)

加更 09：自动化时间记录工具：Timing

[macOS 蓝皮书](https://sspai.com/series/294)

[下一期](https://sspai.com/post/78735)

加更 11：驾驭生活的周期与变化，你的重复提醒利器：Due

[📎 在印象笔记中打开](evernote:///view/207087/s1/e16ee337-9c93-4cf1-8753-26acc58e18bd/e16ee337-9c93-4cf1-8753-26acc58e18bd/)
