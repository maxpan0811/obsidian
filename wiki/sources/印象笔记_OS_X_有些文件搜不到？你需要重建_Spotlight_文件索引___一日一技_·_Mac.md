---
title: "OS X 有些文件搜不到？你需要重建 Spotlight 文件索引 _ 一日一技 · Mac"
type: source
created: 2026-07-15
updated: 2026-07-15
source_path: 印象笔记管理工具/OS X 有些文件搜不到？你需要重建 Spotlight 文件索引 _ 一日一技 · Mac.md
tags: [印象笔记]
---

# OS X 有些文件搜不到？你需要重建 Spotlight 文件索引 _ 一日一技 · Mac

# OS X 有些文件搜不到？你需要重建 Spotlight 文件索引 | 一日一技 · Mac --- ### *关于栏目* 「一日一技」是少数派的全新栏目，我们将会介绍各种简单又实用的小技巧。这些
