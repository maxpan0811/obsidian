---
title: "使用 DEVONthink 和 AppleScript 完成稍后读，并快速分享阅读内容到博客"
type: source
created: 2026-07-15
updated: 2026-07-15
source_path: 印象笔记管理工具/使用 DEVONthink 和 AppleScript 完成稍后读，并快速分享阅读内容到博客.md
tags: [印象笔记]
---

# 使用 DEVONthink 和 AppleScript 完成稍后读，并快速分享阅读内容到博客

# 使用 DEVONthink 和 AppleScript 完成稍后读，并快速分享阅读内容到博客 --- 使用 DEVONthink 和 AppleScript 完成稍后读，并快速分享阅读内容到博客 
