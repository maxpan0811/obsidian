---
title: "用 TileIconifier 自定义 Windows 开始菜单图标 - 少数派"
type: source
created: 2026-07-15
updated: 2026-07-15
source_path: 印象笔记管理工具/用 TileIconifier 自定义 Windows 开始菜单图标 - 少数派.md
tags: [印象笔记]
---

# 用 TileIconifier 自定义 Windows 开始菜单图标 - 少数派

# 用 TileIconifier 自定义 Windows 开始菜单图标 - 少数派 --- 用 TileIconifier 自定义 Windows 开始菜单图标 ==================
