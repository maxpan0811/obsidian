---
title: 🖥 Claude Code Now
type: source
created: 2026-06-14
updated: 2026-06-14
source_path: 印象笔记管理工具/🖥 Claude Code Now.html
tags: [印象笔记, AI/编程]
updated: 2026-06-27
updated: 2026-06-27
updated: 2026-06-27
...
guid: 421d0f55-8aa6-4c01-bfa1-7022a14b333b
---

# 🖥 Claude Code Now

# [claude-code-now](http://claudecodenow.com/ "A ")
...
|  |  |  |
| --- | --- | --- |
| **English** | [中文](https://claudecodenow.com/README.zh.html "A ") | [日本語](https://claudecodenow.com/README.ja.html "A ") |

“Finally, no more typing commands in terminal every time!”

|  |  |
| --- | --- |
| ⭐ **Chosen by 5,000+ users** | [GitHub Stars](https://github.com/orange2ai/claude-code-now "A ") |
...
[**Download v1.6.2 Now**](https://github.com/orange2ai/claude-code-now/releases/download/v1.6.2/Claude.Code.Now.v1.6.2.macOS.zip "A ")
...
- ✅ Open source code, review it yourself [View Source](https://github.com/orange2ai/claude-code-now "A ")
- ✅ Trusted by 5,000+ users

**Q: What do I need to install first?**

- Yes, you need [Claude Code official CLI](https://docs.claude.com/en/docs/claude-code "A ") installed first
- This is the official tool, install once and you’re set

**Q: Does it support Windows?**

- Yes! Check out [Windows Installation Guide](https://claudecodenow.com/#windows-installation "A ")
...
Made by **Orange**, CEO of [ListenHub.AI](https://listenhub.ai/ "A ")
...
- **[Submit Feedback](https://github.com/orange2ai/claude-code-now/issues "A ")** - Having issues? Tell us
- **[Full Documentation](https://github.com/orange2ai/claude-code-now/wiki "A ")** - Detailed usage guide
- **[ListenHub.AI](https://listenhub.ai/ "A ")** - Author’s other projects

---

## ⚡ Get Started Now

[**Click Here to Download v1.6.2**](https://github.com/orange2ai/claude-code-now/releases/download/v1.6.2/Claude.Code.Now.v1.6.2.macOS.zip "A ")
