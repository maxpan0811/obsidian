---
title: 目前速度最快的DeepSeek第三方，手机电脑都能用，小白级部署教程
type: source
created: 2026-06-14
updated: 2026-06-14
source_path: 印象笔记管理工具/目前速度最快的DeepSeek第三方，手机电脑都能用，小白级部署教程.html
tags: [印象笔记, AI/编程]
updated: 2026-06-27
updated: 2026-06-27
updated: 2026-06-27
...
guid: 22a890c4-f25e-490c-b7f5-bca123fd7932
---
...
![](attachments/8481bd4fe9e43295.png)

在这个页面注册账号，手机收验证码（不用尝试其它登录方式，因为最后还是会问你要手机号）：

![](attachments/4bf44f7b3b3c753b.png)

注册成功后进入对话界面，直接可以开始互动：

![](attachments/a8452ae1b0046c01.png)

如果没有进入对话界面，可点击左侧“模型广场”，然后点击DeepSeek-R1：

![](attachments/b4c6bc3e57e41bbb.png)

选择“在线体验”即可进入对话界面：

![](attachments/6ac592f420436c73.png)

你可以随时通过左边的下拉菜单切换其它模型（费用各不相同）：

![](attachments/2db2302d46620f92.png)
...
![](attachments/359060564ec5c842.png)

这里可以填写描述，也可以不填，然后点击“新建密钥”：

![](attachments/8c96a8a57749e253.png)

此时API密钥就建好了，可以将鼠标移到密钥上复制：

![](attachments/c2029f46174d52cc.png)
...
![](attachments/ef0f9554ffdbf2a9.png)

首先尝试Windows版，下载安装后初次启动会弹出这个界面，选择“使用自己的API Key或本地模型”：

![](attachments/1ecbaf4d043acc54.png)

然后选择“SiliconFlow API”：

![](attachments/84006329522e11ed.png)

接下来，把刚才复制的密钥黏贴到“密钥”栏，并在下拉菜单中选择DeepSeek-R1：

![](attachments/4c9c174874f90a7e.png)

通过上方菜单可以设置其它参数，比如是否显示消息的Token数量：

![](attachments/5dbac11b89e4a2a1.png)

是否自动生成聊天标题：

![](attachments/2a5be2e002fd9278.png)

设置完成后“保存”就来到了聊天界面，可以通过左边“新对话”开启新互动，之前聊天记录会保留：

![](attachments/3cec2bbbdc56683f.png)

遗憾的是，虽然Chatbox有联网和上传文件的选项，但使用的话，会提示API不支持。要实现联网功能，只能自己用浏览器插件，这里不多介绍。

![](attachments/2d10c6bd80e89ad9.png)

手机端的安装如出一辙：首先在安卓商店或苹果商店找到Chatbox AI（认准图标别搞错了）：

![](attachments/6aac03723b30e34c.png)![](attachments/1d3872edebcb9271.png)

以安卓为例，安装Chatbox AI之后，同样会弹出这个界面：

![](attachments/0fae78147f3160f2.png)

接下来操作和Windows一样：

![](attachments/6179eed415fc76a8.png)

很快就可以使用了，反应速度比较快：

![](attachments/75d0b3d42b5d81ed.png)
