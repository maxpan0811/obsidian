---
title: 打脸Claude Code！Codex 全端支持第三方模型接入
type: source
created: 2026-06-20
updated: 2026-06-20
source: 印象笔记
source_path: 印象笔记管理工具/打脸Claude Code！Codex 全端支持第三方模型接入.html
tags: [印象笔记]
updated: 2026-06-27
updated: 2026-06-27
updated: 2026-06-27
...
guid: 6cd32a5d-3c5f-4f67-bb89-14490429137f
---
...
![](attachments/eb87c7f0563eb3e4.png)

实时同步官方最新的最全的 Codex 配置字段，每一条都增加了详细的注解和说明。

![](attachments/bbbb131cda1d01f0.png)

提供了最简化的配置，所有的配置完成之后，可以通过一键下载或者复制的方式在本地的.codex 目录中进行使用。

![](attachments/8eea342e9c5df232.png)
