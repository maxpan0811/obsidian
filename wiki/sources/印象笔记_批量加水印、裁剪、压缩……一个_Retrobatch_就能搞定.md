---
title: "批量加水印、裁剪、压缩……一个 Retrobatch 就能搞定"
type: source
created: 2026-07-15
updated: 2026-07-15
source_path: 印象笔记管理工具/批量加水印、裁剪、压缩……一个 Retrobatch 就能搞定.md
tags: [印象笔记]
---

# 批量加水印、裁剪、压缩……一个 Retrobatch 就能搞定

# 批量加水印、裁剪、压缩……一个 Retrobatch 就能搞定 --- 如果只是批量压缩图片，那么 Mac 上有不少软件可以做到；如果还需要批量裁剪、调色、加边框、加滤镜呢？剩下的选择就屈指可数了
