...
# Markdown 完全入门（上） - 少数派 --- Markdown 完全入门（上） ================ 为什么我要写这篇教程 ---------- 思考是人类活动的核心之一，而文
...
1. 首先希望不了解 Markdown 的用户真正地理解这个工具的**本质和优势**，解决「为什么我要用 Markdown」这个元问题
2. 其次是**对 Markdwon 的语法有着有逻辑的了解**，以免陷入各个语法版本的混乱之中，这就解决了「怎么使用 Markdown」的问题
3. 最后就是**工具的选择和使用场景的介绍**，来帮助你开启使用 Markdown 之路。
...
注意：插入网络链接和图片的书写方式不止上面演示的一种，更全面的介绍可以查看 [完整文档](http://wowubuntu.com/markdown/)。
...
**继续阅读：**[Markdown 完全入门（下）](https://sspai.com/post/36682)

---

**相关阅读：**

* 1特别是没有任何编程语言知识和习惯了富文本编辑器的用户。
* 2严格来说 Word 是一款文字处理软件，其中一部分功能起到了富文本编辑器的作用。在这篇文章中我们只讨论它作为文本编辑器的功能，而不涉及两者的定位差别。
* 3少数 Markdown 编辑器可以即时显示出效果。
* 4这里的错误都是指使用者由于没有正确使用功能造成的错误，而非软件设计的问题。

---

[🌐 原始链接](https://sspai.com/post/36610)

[📎 在印象笔记中打开](evernote:///view/207087/s1/63e72eb6-6771-4d84-9d91-2d7c5c84f90a/63e72eb6-6771-4d84-9d91-2d7c5c84f90a/)